        ...
        <div className="max-w-6xl mx-auto relative z-10">
          <div className="flex flex-col md:flex-row justify-between items-start gap-12 mb-20">
            <div className="max-w-sm">
              <h3 className="text-3xl font-black text-orange-500 italic uppercase tracking-tighter mb-6">Maxie's Kitchen</h3>
              <p className="text-gray-400 font-medium leading-relaxed uppercase text-xs tracking-widest">Trade Fair 2026 — The elite pre-order experience. High-quality fuel for the bold.</p>
            </div>
