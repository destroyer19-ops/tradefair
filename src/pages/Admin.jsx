...
const Admin = () => {
  ...
  const stats = useMemo(() => {
    ...
    const referralCounts = paidOrders.reduce((acc, o) => {
      if (o.referred_by) {
        acc[o.referred_by] = (acc[o.referred_by] || 0) + 1;
      }
      return acc;
    }, {});
  ...
  const filteredOrders = useMemo(() => {
    return orders.filter((order) => {
      ...
      const matchDay =
        filterDay === "all" || order.pickup_day === parseInt(filterDay);
      const matchReferrer =
        filterReferrer === "all" || order.referred_by === filterReferrer;
      const matchSearch =
      ...
      <div className="p-8 max-w-[1600px] mx-auto">
        ...
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 mb-8">
          {[
            ...
            <div
              key={i}
              className="bg-gray-900 border border-gray-800 p-6 rounded-2xl shadow-sm"
            >
            ...
            {scannedOrder ? (
              ...
              >
                ...
                <div>
                  ...
                  <p className="text-xl font-bold text-white leading-tight">
                    {scannedOrder.student_name}
                  </p>
                  <p className="text-orange-500 font-mono font-bold mt-1">
                ...
                <div className="grid grid-cols-2 gap-4 pt-2 border-t border-gray-800">
                  <div>
                    <p className="text-gray-500 text-[10px] font-bold uppercase mb-0.5">
                      Package
                    </p>
                    <p className="text-sm font-medium">
                      {scannedOrder.packages?.name}
                    </p>
                  </div>
                  <div>
                    <p className="text-gray-500 text-[10px] font-bold uppercase mb-0.5">
              ...
              <div className="bg-red-500/10 border border-red-500/30 rounded-2xl p-6 text-center">
                ...
                <button
                  ...
                  className="mt-4 text-xs text-white bg-gray-800 px-4 py-2 rounded-lg"
                >
                  Try Again
                </button>
              </div>
              ...
              <div className="bg-gray-900/50 border border-dashed border-gray-800 rounded-2xl p-12 text-center flex flex-col items-center justify-center gap-3">
                ...
                <p className="text-gray-500 text-sm font-medium">
                  Scan a QR code or enter code below to verify ticket
                </p>
              </div>
            )}
                ...
                <table className="w-full text-sm">
                  <thead>
                    <tr className="border-b border-gray-800 bg-gray-900/50">
                      ...
                      <th className="text-left px-6 py-4 text-gray-500 font-bold uppercase text-[10px] tracking-widest text-center">
                        Day
                      </th>
                      <th className="text-left px-6 py-4 text-gray-500 font-bold uppercase text-[10px] tracking-widest">
                        Referrer
                        ...
                        >
                          ...
                          <td className="px-6 py-4">
                            ...
                            <p className="text-[10px] text-gray-600 uppercase font-bold">
                              ₦{(order.packages?.price / 100).toLocaleString()}
                            </p>
                          </td>
                          <td className="px-6 py-4 text-center">
                            <span className="bg-gray-800 px-2 py-1 rounded text-xs font-bold text-gray-400">
                              D{order.pickup_day}
                            </span>
                          </td>
                          <td className="px-6 py-4">
                      ...
                      <tr>
                        <td colSpan="4" className="px-6 py-20 text-center">
                          ...
                          <button
                            ...
                            className="text-orange-500 text-xs mt-2 font-bold hover:underline"
                          >
                            Clear all filters
                          </button>
                        </td>
